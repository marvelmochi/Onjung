...
public class PreferenceTestActivity extends AppCompatActivity
    ...
    //* Main에서 받아온 현 위치
    ArrayList<String> recentPosition_main = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // MainActivity에서 현위치 받아오기
        Intent intent_main = getIntent();
        recentPosition_main = intent_main.getStringArrayListExtra("recentPosition");
        recentPosition.add(recentPosition_main.get(0));
        recentPosition.add(recentPosition_main.get(1));
    ...
    class HttpConnectorMood extends Thread {
        ...
        public void run() {
            ...
            intentResult.putStringArrayListExtra("recentPosition", recentPosition);
            /*
