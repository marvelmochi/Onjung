...
public class PreferenceTestResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("로그: FirstName: "+FirstName);
        System.out.println("로그: SecondName: "+SecondName);
        System.out.println("로그: ThirdName: "+ThirdName);

        System.out.println("로그: firstPoint_lon: "+firstPoint_lon);
        System.out.println("로그: secondPoint_lon: "+secondPoint_lon);
        System.out.println("로그: thirdPoint_lon: "+thirdPoint_lon);
        System.out.println("로그: firstPoint_lat: "+firstPoint_lat);
        System.out.println("로그: secondPoint_lat: "+secondPoint_lat);
        System.out.println("로그: thirdPoint_lat: "+thirdPoint_lat);
        //
        ...
        tMapData2.findPathDataWithType(TMapData.TMapPathType.PEDESTRIAN_PATH, home, home, spots2, 10, new TMapData.FindPathDataListenerCallback() {
            @Override
        ...
        tMapData3.findPathDataWithType(TMapData.TMapPathType.PEDESTRIAN_PATH, home, home, spots3, 10, new TMapData.FindPathDataListenerCallback() {
            @Override
            public void onFindPathData(TMapPolyLine tMapPolyLine) {
                tMapView_x.addTMapPath(tMapPolyLine);
                double distance = tMapPolyLine.getDistance() * 0.001;
