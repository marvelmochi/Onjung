...
public class ShowCourseActivity extends AppCompatActivity {
    ...
    SharedPreferences preferences_course;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        preferences_course = this.getSharedPreferences("CourseInfo", Context.MODE_PRIVATE);

        title = preferences_course.getString("title", "");
        ...
        home_lat = preferences_course.getString("home_lat", "");
        home_lon = preferences_course.getString("home_lon", "");
        jname_s = preferences_course.getString("jname", "");
        jlat_s = preferences_course.getString("jlat", "");
        jlon_s = preferences_course.getString("jlon", "");
        walkId = preferences_course.getString("walkId", "");
        jspot_s = preferences_course.getString("jspot", "");
    ...
    public void walkingClicked(View view) {
        Intent intent = new Intent(ShowCourseActivity.this, WalkingActivity.class);
    ...
    public void courseConverter(String jname){
        try {


        }catch (Exception e){
            e.printStackTrace();
            System.out.println("로그: 산책로 정보 텍스트 변환 예외 발생 ");
        }
    }
